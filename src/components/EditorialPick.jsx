// components/EditorialPicks.js
import { editorialPicks } from '../data/restaurantsData';

const EditorialPicks = () => {
    return (
        <div className="py-8">
            <h2 className="p-3 mb-8 text-4xl font-bold text-center text-white bg-blue-600">Editorial Picks</h2>
            <div className="grid grid-cols-2 gap-8 p-8">
                {editorialPicks.map((restaurant) => (
